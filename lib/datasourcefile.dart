class DataSource {
  static List starterText = [
    "Be informed, prepared, smart and safe. Be ready to fight covid-19!.It's a matter of how we use our best efforts to drive this down.",
    "A pandemic of this magnitude takes a 'huge level of health worker commitment' citing shortages in workers and personal protective equipment to treat the current number of COVID-19 cases, according to Dr. Michael J. Ryan, WHO Informal Advisory Group.",
    "If you develop shortness of breath, call your doctor immediately.."
  ];

  static List dashButtons = [
    'assets/symptoms.svg',
    'assets/safety.svg',
    'assets/stats.svg',
    'assets/sanitize.svg',
  ...
  static List starterImages = [
    'assets/corona.jpg',
    'assets/dashheader.jpg',
    'assets/doctor.png',
